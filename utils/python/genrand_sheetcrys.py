...
while True:
    ...
    a=(random.uniform(vmin,vmax))**(1.0/3)
    b=(random.uniform(vmin,vmax))**(1.0/3)
    gama=pi/(random.uniform(1.5,7))
    #c=random.uniform(vmin/(a*b*math.sin(gama)),vmax/(a*b*math.sin(gama)))
    #c=vmax/(a*b*math.sin(gama))
    c=20#vmin/(a*b*math.sin(gama))
    cell_vec=[[0,0,0],[0,0,0],[0,0,0]]
    xan=[0 for i in range(nan)];yan=[0 for i in range(nan)];zan=[0 for i in range(nan)]
    xcat=[0 for i in range(ncat)];ycat=[0 for i in range(ncat)];zcat=[0 for i in range(ncat)]
    #----------------------------------------------------------------------------------------------------------
    ...
    while i < 27*nat:
        ...
        rand3=random.uniform(0.31,0.62)
...
poscur.write("# keyword:fixlat   F  F  T  T  T  F  F\n")
for i in range(ncat):
