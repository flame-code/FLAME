...
!   dt=parini%dt_dynamics
    ...
    do imd=1+rmd,nmd+rmd
        ...
        atomic2Gpa= 29421.02648438959d0
        write(1377,*) 'imd , stress_trace/3 (Gpa) = ' , imd , atomic2Gpa*(atoms%stress(1,1)+atoms%stress(2,2)+atoms%stress(3,3))/(3.d0*vol)
