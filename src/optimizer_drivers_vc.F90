...
subroutine vc_minimize(parini,iproc,atoms,paropt)
    use mod_interface, except_this_one=>vc_minimize
...
subroutine vc_test_convergence(n,f,paropt)
    use mod_interface, except_this_one=>vc_test_convergence
    use mod_opt, only: typ_paropt
    implicit none
    integer, intent(in):: n
...
subroutine vc_x_to_xr(atoms,nr,xr,fr)
    use mod_interface, except_this_one=>vc_x_to_xr
...
subroutine vc_xr_to_x(nr,xr,atoms)
    use mod_interface, except_this_one=>vc_xr_to_x
...
subroutine vc_report_param(paropt)
    use mod_interface, except_this_one=>vc_report_param
    use mod_opt, only: typ_paropt
    implicit none
    type(typ_paropt), intent(inout):: paropt
    !local variables
