...
subroutine flm_print_logo(parini)
    ...
    call yaml_scalar('"_____________________________ Fully-Loaded Atomistic Modeling Environment')
    call yaml_scalar('|_____|_____|_____|_____|_____|____      www.flame-code.org   "')
