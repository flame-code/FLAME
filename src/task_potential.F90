...
subroutine alborz_as_potential_init(nat,sat)
    use mod_interface, except_this_one=>alborz_as_potential_init
...
subroutine alborz_as_potential_get(boundcond,nat,cellvec,rat,sat,fat,epot,stress)
    use mod_interface, except_this_one=>alborz_as_potential_get
...
subroutine alborz_as_potential_final
    use mod_interface, except_this_one=>alborz_as_potential_final
