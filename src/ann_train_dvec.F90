...
module mod_train_dvec
    ...
    implicit none
    private
    public:: ekf_rivals_dvec
    type, extends(typ_cost_object):: typ_cost_object_dvec
        ...
        contains
        procedure, public, pass(self):: init_cost_object_dvec
        procedure, public, pass(self):: fini_cost_object_dvec
        procedure, public, pass(self):: func_value => get_fcn_ann_dvec
        procedure, public, pass(self):: func_write => export_weights_dvec
        procedure, public, pass(self):: func_evaluate => ann_evaluate_all_dvec
    end type typ_cost_object_dvec
contains
!*****************************************************************************************
subroutine init_cost_object_dvec(self,ann_arr,opt_ann,atoms_train,atoms_valid,symfunc_train,symfunc_valid)
    implicit none
    class(typ_cost_object_dvec), intent(inout):: self
...
end subroutine init_cost_object_dvec
!*****************************************************************************************
subroutine fini_cost_object_dvec(self)
    implicit none
    class(typ_cost_object_dvec), intent(inout):: self
    !local variables
...
end subroutine fini_cost_object_dvec
!*****************************************************************************************
subroutine ekf_rivals_dvec(parini,ann_arr,opt_ann,refdata)
    ...
    !local variables
    type(typ_cost_object_dvec):: cost_object_dvec
    ...
    call cost_object_dvec%init_cost_object_dvec(ann_arr,opt_ann,atoms_train,atoms_valid,symfunc_train,symfunc_valid)
    call ekf_rivals(cost_object_dvec,parini,opt_ann)
    call cost_object_dvec%fini_cost_object_dvec()
    end associate
    end associate
end subroutine ekf_rivals_dvec
!*****************************************************************************************
subroutine get_fcn_ann_dvec(self,parini,idp,opt_ann,fcn_ann,fcn_ref,g)
    use mod_parini, only: typ_parini
    use mod_ann, only: typ_ann_arr
    ...
    if(.not. self%initialized) then
        write(*,'(a)') 'ERROR: typ_cost_object_dvec is not initialized!'
        stop
    endif
...
end subroutine get_fcn_ann_dvec
!*****************************************************************************************
subroutine export_weights_dvec(self,parini,iter)
    use mod_parini, only: typ_parini
...
end subroutine export_weights_dvec
!*****************************************************************************************
subroutine ann_evaluate_all_dvec(self,parini,iter)
    use mod_parini, only: typ_parini
    ...
    call convert_opt_x_ann_arr(opt_ann,ann_arr)
    call analyze_epoch_init_dvec(parini,ann_arr)
    ...
    call analyze_epoch_print_dvec(parini,iter,ann_arr)
    end associate
    end associate
    end associate
end subroutine ann_evaluate_all_dvec
!*****************************************************************************************
subroutine analyze_epoch_init_dvec(parini,ann_arr)
    use mod_parini, only: typ_parini
    use mod_ann, only: typ_ann_arr
    implicit none
    type(typ_parini), intent(in):: parini
...
end subroutine analyze_epoch_init_dvec
!*****************************************************************************************
subroutine analyze_epoch_print_dvec(parini,iter,ann_arr)
    use mod_parini, only: typ_parini
    use mod_ann, only: typ_ann_arr
    use mod_flm_futile
    implicit none
    ...
    do i=1,parini%ntypat
        ...
        !close(71)
    enddo
end subroutine analyze_epoch_print_dvec
!*****************************************************************************************
end module mod_train_dvec
!*****************************************************************************************
