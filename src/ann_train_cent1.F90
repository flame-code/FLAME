...
module mod_train_cent1
    ...
    implicit none
    private
    public:: ekf_rivals_cent1
    type, extends(typ_cost_object):: typ_cost_object_cent1
        ...
        contains
        procedure, public, pass(self):: init_cost_object_cent1
        procedure, public, pass(self):: fini_cost_object_cent1
        procedure, public, pass(self):: func_value => get_fcn_ann_cent1
        procedure, public, pass(self):: func_write => export_weights_cent1
        procedure, public, pass(self):: func_evaluate => ann_evaluate_all_cent1
    end type typ_cost_object_cent1
contains
!*****************************************************************************************
subroutine init_cost_object_cent1(self,ann_arr,opt_ann,atoms_train,atoms_valid,symfunc_train,symfunc_valid)
    implicit none
    class(typ_cost_object_cent1), intent(inout):: self
...
end subroutine init_cost_object_cent1
!*****************************************************************************************
subroutine fini_cost_object_cent1(self)
    implicit none
    class(typ_cost_object_cent1), intent(inout):: self
    !local variables
...
end subroutine fini_cost_object_cent1
!*****************************************************************************************
subroutine ekf_rivals_cent1(parini,ann_arr,opt_ann,refdata)
    ...
    !local variables
    type(typ_cost_object_cent1):: cost_object_cent1
    ...
    call cost_object_cent1%init_cost_object_cent1(ann_arr,opt_ann,atoms_train,atoms_valid,symfunc_train,symfunc_valid)
    call ekf_rivals(cost_object_cent1,parini,opt_ann)
    call cost_object_cent1%fini_cost_object_cent1()
    end associate
    end associate
end subroutine ekf_rivals_cent1
!*****************************************************************************************
subroutine get_fcn_ann_cent1(self,parini,idp,opt_ann,fcn_ann,fcn_ref,g)
    use mod_parini, only: typ_parini
    use mod_ann, only: typ_ann_arr
    ...
    if(.not. self%initialized) then
        write(*,'(a)') 'ERROR: typ_cost_object_cent1 is not initialized!'
        stop
    endif
...
end subroutine get_fcn_ann_cent1
!*****************************************************************************************
subroutine export_weights_cent1(self,parini,iter)
    use mod_parini, only: typ_parini
...
end subroutine export_weights_cent1
!*****************************************************************************************
subroutine ann_evaluate_all_cent1(self,parini,iter)
    use mod_parini, only: typ_parini
    ...
    call convert_opt_x_ann_arr(opt_ann,ann_arr)
    call analyze_epoch_init_cent1(parini,ann_arr)
    ...
    call analyze_epoch_print_cent1(parini,iter,ann_arr)
    end associate
    end associate
    end associate
end subroutine ann_evaluate_all_cent1
!*****************************************************************************************
subroutine analyze_epoch_init_cent1(parini,ann_arr)
    use mod_parini, only: typ_parini
    use mod_ann, only: typ_ann_arr
    implicit none
    type(typ_parini), intent(in):: parini
...
end subroutine analyze_epoch_init_cent1
!*****************************************************************************************
subroutine analyze_epoch_print_cent1(parini,iter,ann_arr)
    use mod_parini, only: typ_parini
    use mod_ann, only: typ_ann_arr
    use mod_flm_futile
    implicit none
    ...
    do i=1,parini%ntypat
        ...
        !close(71)
    enddo
end subroutine analyze_epoch_print_cent1
!*****************************************************************************************
end module mod_train_cent1
!*****************************************************************************************
