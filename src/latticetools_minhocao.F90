 ...
 use mod_interface, except_this_one=>dist2line
 implicit none
...
!**********************************************************************************************
 ...
 !and the output is the distance 'dist'  
 use mod_interface, except_this_one=>dist2plane
 implicit none
...
use mod_interface, except_this_one=>dist_ang2latvec
...
use mod_interface, except_this_one=>dist_latvec2ang
...
!**********************************************************************************************
 ...
 use mod_interface, except_this_one=>dproj2latvec
...
!**********************************************************************************************
 ...
 use mod_interface, except_this_one=>latvec2dproj
...
!**********************************************************************************************
 ...
 use mod_interface, except_this_one=>rxyz_cart2int
...
!**********************************************************************************************
 ...
 use mod_interface, except_this_one=>strten2flat
...
use mod_interface, except_this_one=>rotate_stresstensor
implicit none
...
! This code will define the KPT mesh based on the desired grid density
   use mod_interface, except_this_one=>find_kpt
   implicit none
...
use mod_interface, except_this_one=>rotmat_fcart_stress
implicit none
...
!**********************************************************************************************
 ...
 use mod_interface, except_this_one=>updaterxyz
