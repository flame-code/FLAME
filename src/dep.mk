./es_coulomb_p3d_bias.o : ./es_coulomb_p3d_bias.F90 fftw3.f ./parini_mod.o ./potential_mod.o ./atoms_mod.o ./electrostatics_mod.o 
...
./ann_pot_centt.o : ./ann_pot_centt.F90 ./electrostatics_mod.o ./linked_lists_mod.o ./symfunc_mod.o ./ann_mod.o ./atoms_mod.o ./parini_mod.o 
...
./potential_main_vc.o : ./potential_main_vc.F90 ./potential_mod.o ./atoms_mod.o 
./potential_LenoskyTB_minhocao.o : ./potential_LenoskyTB_minhocao.F90 ./parini_mod.o ./constants_minhocao_mod.o ./minhocao_mod.o 
./potential_VASP.o : ./potential_VASP.F90 ./processors_mod.o ./atoms_mod.o ./potential_mod.o 
...
./optimizer_drivers.o : ./optimizer_drivers.F90 ./io_bin.o ./opt_mod.o ./atoms_mod.o ./parini_mod.o 
./task_netsock.o : ./task_netsock.F90 ./minhocao_mod.o ./io_yaml_conf.o ./io_acf.o ./fsockets.o ./constants_mod.o ./processors_mod.o ./potential_mod.o ./atoms_mod.o ./parini_mod.o 
...
./potential_DFTB.o : ./potential_DFTB.F90 ./constants_mod.o ./potential_mod.o ./processors_mod.o ./atoms_mod.o 
./optimizer_cg.o : ./optimizer_cg.F90 ./opt_mod.o 
./genconf_diatomic.o : ./genconf_diatomic.F90 ./io_acf.o ./constants_mod.o ./potential_mod.o ./processors_mod.o ./genconf_mod.o ./atoms_mod.o ./parini_mod.o 
./optimizer_diis.o : ./optimizer_diis.F90 ./opt_mod.o 
./ann_gen_symmetry_function.o : ./ann_gen_symmetry_function.F90 ./processors_mod.o ./atoms_mod.o ./symfunc_mod.o ./ann_mod.o ./parini_mod.o 
./potential_LenoskyMEAM.o : ./potential_LenoskyMEAM.F90 ./parini_mod.o ./constants_minhocao_mod.o ./minhocao_mod.o 
./task_potential.o : ./task_potential.F90 ./atoms_mod.o ./potential_mod.o ./flame_as_potential_mod.o 
...
./train_optimizer.o : ./train_optimizer.F90 ./basic_utilities.o ./atoms_mod.o ./ann_mod.o ./symfunc_mod.o ./processors_mod.o ./parini_mod.o ./ann_mod.o 
./potential_DFTB_minhocao.o : ./potential_DFTB_minhocao.F90 ./parini_mod.o ./constants_minhocao_mod.o ./minhocao_mod.o 
./task_single_point.o : ./task_single_point.F90 ./minhocao_mod.o ./constants_mod.o ./processors_mod.o ./io_yaml_conf.o ./io_acf.o ./potential_mod.o ./atoms_mod.o ./parini_mod.o 
...
./potential_NetSock.o : ./potential_NetSock.F90 ./parini_mod.o ./atoms_mod.o ./potential_mod.o ./fsockets.o 
./bader_mod.o : ./bader_mod.F90 
./md.o : ./md.F90 ./md_util.o ./processors_mod.o ./dynamics_mod.o ./atoms_mod.o ./potential_mod.o ./io_acf.o ./parini_mod.o 
...
./potential_BLJ_vc.o : ./potential_BLJ_vc.F90 ./potential_mod.o 
...
./saddle_1s_pot.o : ./saddle_1s_pot.F90 ./potential_mod.o ./processors_mod.o ./opt_mod.o ./atoms_mod.o ./parini_mod.o 
./potential_CP2K.o : ./potential_CP2K.F90 ./parini_mod.o ./constants_minhocao_mod.o ./minhocao_mod.o 
./ascii2POSCAR.o : ./ascii2POSCAR.F90 
./ann_symfunc_atom_behler.o : ./ann_symfunc_atom_behler.F90 ./linked_lists_mod.o ./atoms_mod.o ./symfunc_mod.o ./ann_mod.o ./parini_mod.o 
...
./md_NVT.o : ./md_NVT.F90 ./processors_mod.o ./dynamics_mod.o ./md_util.o ./io_acf.o ./atoms_mod.o ./potential_mod.o ./parini_mod.o 
./es_hartree_kspace.o : ./es_hartree_kspace.F90 fftw3.f 
./es_coulomb_spline.o : ./es_coulomb_spline.F90 ./definitions_mod.o ./spline_mod.o ./shortrange_mod.o 
./es_coulomb_p3d_dielec.o : ./es_coulomb_p3d_dielec.F90 fftw3.f ./parini_mod.o ./potential_mod.o ./atoms_mod.o ./electrostatics_mod.o 
./potential_mod.o : ./potential_mod.F90 ./shortrange_mod.o ./electrostatics_mod.o ./ann_mod.o 
./barsaddle.o : ./barsaddle.F90 ./basic_utilities.o ./io_yaml_conf.o ./potential_mod.o ./atoms_mod.o ./processors_mod.o ./parini_mod.o 
./optimizer_fire.o : ./optimizer_fire.F90 ./opt_mod.o ./parini_mod.o 
./potential_main.o : ./potential_main.F90 ./processors_mod.o ./potential_mod.o ./atoms_mod.o ./parini_mod.o 
./ann_io.o : ./ann_io.F90 ./io_acf.o ./atoms_mod.o ./processors_mod.o ./ann_mod.o ./parini_mod.o 
./minhopp.o : ./minhopp.F90 ./io_bin.o ./basic_utilities.o ./potential_mod.o ./io_yaml_conf.o ./opt_mod.o ./atoms_mod.o ./processors_mod.o ./minhopp_mod.o ./task_mod.o ./parini_mod.o 
./potential_abinit.o : ./potential_abinit.F90 ./parini_mod.o ./constants_minhocao_mod.o ./minhocao_mod.o 
./forcefield.o : ./forcefield.F90 ./electrostatics_mod.o ./potential_mod.o ./atoms_mod.o ./parini_mod.o 
./io_yaml_conf.o : ./io_yaml_conf.F90 ./io_acf.o ./constants_mod.o ./atoms_mod.o ./parini_mod.o 
./ann_symfunc_atom_stefan.o : ./ann_symfunc_atom_stefan.F90 ./atoms_mod.o ./symfunc_mod.o ./ann_mod.o ./parini_mod.o 
...
./minhopp_pot.o : ./minhopp_pot.F90 ./potential_mod.o ./processors_mod.o ./opt_mod.o ./atoms_mod.o ./parini_mod.o 
...
./splinedsaddle.o : ./splinedsaddle.F90 ./splinedsaddle_mod.o ./splinedsaddle_mod.o ./io_yaml_conf.o ./potential_mod.o ./atoms_mod.o ./processors_mod.o ./parini_mod.o 
...
./ann_pot_atom.o : ./ann_pot_atom.F90 ./linked_lists_mod.o ./symfunc_mod.o ./ann_mod.o ./atoms_mod.o ./parini_mod.o 
./task_genconf.o : ./task_genconf.F90 ./parini_mod.o ./genconf_mod.o 
./ann_pot_cent_common.o : ./ann_pot_cent_common.F90 ../src/act2_cell_linkedlist.inc ../src/act1_cell_linkedlist.inc ./linked_lists_mod.o ./atoms_mod.o ./symfunc_mod.o ./ann_mod.o ./parini_mod.o 
./task_geopt.o : ./task_geopt.F90 ./constants_mod.o ./io_yaml_conf.o ./processors_mod.o ./io_acf.o ./potential_mod.o ./atoms_mod.o ./opt_mod.o ./parini_mod.o 
...
./potential_MPMD.o : ./potential_MPMD.F90 ./processors_mod.o ./constants_mod.o ./atoms_mod.o ./potential_mod.o 
...
./ann_pot_cent2.o : ./ann_pot_cent2.F90 ./linked_lists_mod.o ./electrostatics_mod.o ./symfunc_mod.o ./ann_mod.o ./atoms_mod.o ./parini_mod.o 
./saddle_1s_optimizer.o : ./saddle_1s_optimizer.F90 ./saddle_mod.o ./atoms_mod.o ./potential_mod.o ./opt_mod.o ./parini_mod.o 
...
./potential_BigDFT.o : ./potential_BigDFT.F90 ./processors_mod.o ./atoms_mod.o ./potential_mod.o 
...
./task_lammps.o : ./task_lammps.F90 ./lammps_mod.o ./io_acf.o ./potential_LAMMPS_interface.o ./potential_mod.o ./atoms_mod.o ./parini_mod.o 
./minhocao_mod.o : ./minhocao_mod.F90 
./potential_QSC.o : ./potential_QSC.F90 ./constants_mod.o ./atoms_mod.o ./potential_mod.o 
...
./potential_ANN.o : ./potential_ANN.F90 ../src/act2_cell_linkedlist.inc ../src/act1_cell_linkedlist.inc ./linked_lists_mod.o ./train_optimizer.o ./symfunc_mod.o ./ann_mod.o ./potential_mod.o ./atoms_mod.o ./parini_mod.o 
...
./ann_pot_cent1.o : ./ann_pot_cent1.F90 ./linked_lists_mod.o ./electrostatics_mod.o ./symfunc_mod.o ./ann_mod.o ./atoms_mod.o ./parini_mod.o 
./spline_mod.o : ./spline_mod.F90 
./optimizer_drivers_vc.o : ./optimizer_drivers_vc.F90 ./opt_mod.o ./io_acf.o ./atoms_mod.o ./parini_mod.o 
...
./genconf_trimer.o : ./genconf_trimer.F90 ./io_acf.o ./potential_mod.o ./processors_mod.o ./genconf_mod.o ./atoms_mod.o ./parini_mod.o 
./ann_best_symfunc.o : ./ann_best_symfunc.F90 ./processors_mod.o ./atoms_mod.o ./symfunc_mod.o ./ann_mod.o ./parini_mod.o 
./phonon.o : ./phonon.F90 ./io_yaml_conf.o ./potential_mod.o ./processors_mod.o ./atoms_mod.o ./parini_mod.o 
./ann_pot_main.o : ./ann_pot_main.F90 ./symfunc_mod.o ./tightbinding_mod.o ./ann_train.o ./atoms_mod.o ./train_optimizer.o ./ann_mod.o ./parini_mod.o 
./spglib_int.o : ./spglib_int.F90 
./ann_evaluate.o : ./ann_evaluate.F90 ./atoms_mod.o ./symfunc_mod.o ./ann_mod.o ./parini_mod.o 
./fingerprint.o : ./fingerprint.F90 ./constants_minhocao_mod.o ./minhocao_mod.o ./minhocao_mod.o ./parini_mod.o 
./potential_LTB.o : ./potential_LTB.F90 ./parini_mod.o ./tightbinding_mod.o ./atoms_mod.o ./potential_mod.o 
./task_testforces.o : ./task_testforces.F90 ./io_yaml_conf.o ./io_acf.o ./constants_mod.o ./processors_mod.o ./potential_mod.o ./atoms_mod.o ./parini_mod.o 
...
./ann_symfunc_main.o : ./ann_symfunc_main.F90 ./atoms_mod.o ./symfunc_mod.o ./ann_mod.o ./parini_mod.o 
./fingerprint_oganov.o : ./fingerprint_oganov.F90 ./parini_mod.o 
./optimizer_sqnm.o : ./optimizer_sqnm.F90 ./processors_mod.o ./opt_mod.o ./atoms_mod.o ./parini_mod.o 
...
./saddle_1s_dimer.o : ./saddle_1s_dimer.F90 ./basic_utilities.o ./io_yaml_conf.o ./atoms_mod.o ./opt_mod.o ./saddle_mod.o ./parini_mod.o 
./ann_pot_cent3.o : ./ann_pot_cent3.F90 ./linked_lists_mod.o ./symfunc_mod.o ./ann_mod.o ./atoms_mod.o ./parini_mod.o 
...
./potential_SIESTA.o : ./potential_SIESTA.F90 ./atoms_mod.o ./potential_mod.o 
./ann_pot_tb.o : ./ann_pot_tb.F90 ./ann_mod.o ./constants_mod.o ./linked_lists_mod.o ./train_optimizer.o ./symfunc_mod.o ./ann_mod.o ./atoms_mod.o ./tightbinding_mod.o ./tightbinding_mod.o ./parini_mod.o 
./ann_symfunc_pair_behler.o : ./ann_symfunc_pair_behler.F90 ./linked_lists_mod.o ./atoms_mod.o ./symfunc_mod.o ./ann_mod.o ./parini_mod.o 
...
./ann_check_symmetry_function.o : ./ann_check_symmetry_function.F90 ./processors_mod.o ./atoms_mod.o ./symfunc_mod.o ./ann_mod.o ./parini_mod.o 
./potential_sec_main.o : ./potential_sec_main.F90 ./potential_mod.o ./atoms_mod.o ./parini_mod.o 
./saddle_1s.o : ./saddle_1s.F90 ./basic_utilities.o ./constants_mod.o ./processors_mod.o ./io_yaml_conf.o ./opt_mod.o ./saddle_mod.o ./potential_mod.o ./atoms_mod.o ./parini_mod.o 
...
./ann_train.o : ./ann_train.F90 ./linked_lists_mod.o ./basic_utilities.o ./processors_mod.o ./train_optimizer.o ./symfunc_mod.o ./ann_mod.o ./parini_mod.o ./atoms_mod.o 
