!*****************************************************************************************
subroutine initprocessors(mpi_env)
    use mod_processors, only: parallel, nproc, iproc, iproc_world, nproc_world, imaster, &
        iproc_type_all, iproc_list_abz, mpi_group_world, mpi_group_abz
    ...
    call MPI_COMM_CREATE(MPI_COMM_WORLD,mpi_group_abz,mpi_env%mpi_comm,ierr)
    call MPI_COMM_RANK(mpi_env%mpi_comm,iproc,ierr)
    call MPI_COMM_SIZE(mpi_env%mpi_comm,nproc,ierr)
...
!*****************************************************************************************
subroutine finalizeprocessors(mpi_env)
    use mod_processors, only: parallel, mpi_group_abz, mpi_group_world, &
