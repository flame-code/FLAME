# -*- coding: utf-8 -*-
#
# futile documentation build configuration file, created by
...
pythonfutilepath = os.path.join(futilepath, 'python')
...
# html_logo = 'futile.ico' #FutileLogo.png'
# Theme options are theme-specific and customize the look and feel of a theme
# further.  For a list of options available for each theme, see the
# documentation.
#
html_theme_options = {'navbar_site_name': "Contents",
                      'navbar_links': [
                          ("BigDFT Project", "http://www.bigdft.org", True), ],
...
html_logo = '_static/Futile_Logo.png'
html_favicon = '_static/Futile_Logo.png'

# html_favicon = '_static/futile.ico'

# -- Options for HTMLHelp output ------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'futiledoc'
...
latex_documents = [
    (master_doc, 'futile.tex', u'futile Documentation',
...
man_pages = [
    (master_doc, 'futile', u'futile Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'futile', u'futile Documentation',
     author, 'futile', 'One line description of project.',
     'Miscellaneous'),
]
...
fortran_src = [os.path.abspath(dictsdir),
               os.path.abspath(os.path.join(futilepath, 'flib',
                                            'f_utils.f90')),
               os.path.abspath(os.path.join(futilepath, 'flib',
                                            'f_input_file.f90')),
               os.path.abspath(os.path.join(futilepath, 'flib',
